...
##Pmod Header JB
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { left_servo }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
...
##Pmod Header JC
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { right_servo }]; #IO_L23N_T3_35 Sch=jc[1]

...
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { cathode_1 }]; #IO_L17P_T2_35 Sch=jd[2]
...
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { cathode_3 }]; #IO_L13N_T2_MRCC_35 Sch=jd[10]
